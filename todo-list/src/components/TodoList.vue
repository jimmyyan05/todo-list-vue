    ...
    <div class="bg-white rounded-lg shadow" v-show="todos.length">
      ...
      <ul class="flex text-center text-[#9f9a91]">
        <li 
          ...
          :class="{ 'text-[#333] border-[#333] font-bold': toggleStatus === 'all' }" 
          @click="changeTab('all')"
        >全部</li>
        <li 
          class="p-4 w-full border-b-2 border-[#efefef] cursor-pointer hover:text-[#333] hover:border-[#333]/30"
          :class="{ 'text-[#333] border-[#333] font-bold': toggleStatus === 'work' }" 
          @click="changeTab('work')"
        >待完成</li>
        <li 
          class="p-4 w-full border-b-2 border-[#efefef] cursor-pointer hover:text-[#333] hover:border-[#333]/30"
          :class="{ 'text-[#333] border-[#333] font-bold': toggleStatus === 'done' }" 
      ...
      <div class="p-4 px-5">
        ...
        <div class="flex justify-between pt-6 text-sm">
          <p><span>{{ uncompletedCount }}</span> 個待完成項目</p>
          <a 
            href="#" 
